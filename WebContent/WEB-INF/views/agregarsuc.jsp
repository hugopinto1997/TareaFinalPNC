...
<div class="container" style="width: 100%; background-size: 100% 100%; background-repeat: no-repeat; background-image: url('resources/vps.jpg');">
  <div class="jumbotron" style="background-color: #00000070;">
    <h1 style="background-color:#00000000; color:#ffffff90; font-weight:bold;">Agregar Sucursal</h1>      
   ...
   <form:form action="${pageContext.request.contextPath}/savesuc" method="POST" modelAttribute="nsuc1">
	<form:input type="hidden" name="fdsasdf"  path="idSucursal" />	
